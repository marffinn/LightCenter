...
var textures = {
        ...
        polocross: 'lib/models/TEXTURES/polocross.jpg',
        polocrossbrown: 'lib/models/TEXTURES/polocross-brown.jpg',
        polocrossblack: 'lib/models/TEXTURES/polocross-black.jpg',
        ...
        cert: 'lib/models/TEXTURES/cert.jpg',
    
        lightswitch: 'lib/models/TEXTURES/switch.jpg',
...
var models = [
    ...
    [
        _7 = {
            ...
            baza:               'lib/models/2305136/baza.json',
            power_conectors:    'lib/models/2305136/power_conectors.json',
            silver_clips:       'lib/models/2305136/silver_clips.json',
            cert:               'lib/models/2305136/cert.json',
            scala:              1,
            posiy:              -6,
            modposi: function(){
                group.scale.set( this.scala, this.scala, this.scala );
            ...
            loadmodel: function () {
                ...
                var conmat = new THREE.MeshBasicMaterial({
                    shininess: .1,
                    reflectivity: .1,
                    refractionRatio: 0.1,
                    color: 0xFFCC00,
                ...
                var matcert = new THREE.MeshPhongMaterial({
                    map: cx,
                    shininess: 0,
                    reflectivity: 0,
                    bumpMap: b,
                ...
                loader.load(this.power_conectors, function (geo) {
                    var power_conectors = new THREE.Mesh(geo, conmat);
                    power_conectors.material.needsUpdate = true;
                    power_conectors.position.set(0, 0, 0);
                    power_conectors.scale.set(mscale, mscale, mscale);
                    power_conectors.castShadow = true;
                    power_conectors.receiveShadow = true;
                    power_conectors.name = 'power_conectors';
                    group.add(power_conectors);
                });
                ...
                loader.load(this.cert, function (geo) {
                    var cert = new THREE.Mesh(geo, matcert);
                    cert.material.needsUpdate = true;
                    cert.position.set(0, 0, 0);
                    cert.scale.set(mscale, mscale, mscale);
    ...
    [
        _36 = {
            name: 'Spot Light lampa wisząca Trigonon 1171132',
            link: 'https://lightcenter.pl/katalog,19866/spot-light-lampa-wiszaca-trigonon-1171132',
            
            light_source:       'lib/models/1171170/light_source.json',
            main_frame:         'lib/models/1171170/main_frame.json',
            silver_clips:       'lib/models/1171170/silver_clips.json',
            light_bulb:         'lib/models/1171170/light_bulb.json',
            rope:               'lib/models/1171170/rope.json',
            scala:              0.6,
            posiy:             -10,
            modposi: function(){
                group.scale.set( this.scala, this.scala, this.scala );
    ...
    [
        _37 = {
            name: 'Lampa sufitowa Linus LED 2241374 Spot Light',
            link: 'https://lightcenter.pl/katalog,22473/lampa-sufitowa-linus-led-2241374-spot-light',
            
            baza:               'lib/models/2241374/baza.json',
            light_source:       'lib/models/2241374/light_source.json',
            light_switch_ring:  'lib/models/2241374/light_switch_ring.json',
            light_switch:       'lib/models/2241374/light_switch.json',
            scala:              0.6,
            posiy:             -2,
            modposi: function(){
                group.scale.set( this.scala, this.scala, this.scala );
            ...
            loadmodel: function () {
                ...
                var lswitch = new THREE.MeshPhongMaterial({
                    map: jx,
                    shininess: 0,
                    reflectivity: 0,
                    combine: THREE.MultiplyOperation
                ...
                loader.load(this.light_switch, function (geo) {
                    var light_switch = new THREE.Mesh(geo, lswitch);
                    light_switch.material.needsUpdate = true;
                    light_switch.position.set(0, 0, 0);
                    light_switch.scale.set(mscale, mscale, mscale);
                    light_switch.castShadow = true;
                    light_switch.receiveShadow = true;
                    light_switch.name = 'light_switch';
                    group.add(light_switch);
                });
                loader.load(this.light_switch_ring, function (geo) {
                    var light_switch_ring = new THREE.Mesh(geo, matPad);
                    light_switch_ring.material.needsUpdate = true;
                    light_switch_ring.position.set(0, 0, 0);
                    light_switch_ring.scale.set(mscale, mscale, mscale);
                    light_switch_ring.castShadow = true;
                    light_switch_ring.receiveShadow = true;
                    light_switch_ring.name = 'light_switch_ring';
                    group.add(light_switch_ring);
                });
            }
    ...
    [
        _38 = {
            name: 'Lampa sufitowa Linus LED 2242374 Spot Light',
            link: 'https://lightcenter.pl/katalog,22475/lampa-sufitowa-linus-led-2242374-spot-light',
            
            baza:               'lib/models/2242374/baza.json',
            light_source:       'lib/models/2242374/light_source.json',
            light_switch_ring:  'lib/models/2242374/light_switch_ring.json',
            light_switch:       'lib/models/2242374/light_switch.json',
            scala:              0.6,
            posiy:             -2,
            modposi: function(){
                group.scale.set( this.scala, this.scala, this.scala );
    ...
    [
        _40 = {
            name: 'Lampa wisząca Josefina 4774802 Spot Light',
            link: 'https://www.lightcenter.pl/katalog,24114/lampa-wiszaca-maxima-30428a0729-spot-light',
            
            light_source:       'lib/models/4774802/light_source.json',
            top:                'lib/models/4774802/top.json',
            rings:              'lib/models/4774802/rings.json',
            bottom:             'lib/models/4774802/bottom.json',
            baza:               'lib/models/4774802/baza.json',
            scala:              0.6,
            posiy:             -10,
            modposi: function(){
                group.scale.set( this.scala, this.scala, this.scala );
            ...
            loadmodel: function () {
                ...
                var matPad = new THREE.MeshPhongMaterial({
                    color: 0xffffff,
                    reflectivity: 0.6,
                    refractionRatio: 0.1,
                    specular: 0x777777,
                ...
                loader.load(this.baza, function (geo) {
                    var baza = new THREE.Mesh(geo, matBulb);
                    baza.material.needsUpdate = true;
                    baza.position.set(0, 0, 0);
                    baza.scale.set(mscale, mscale, mscale);
                    baza.castShadow = true;
                ...
                loader.load(this.rings, function (geo) {
                    var rings = new THREE.Mesh(geo, matPad);
                    rings.material.needsUpdate = true;
                    rings.position.set(0, 0, 0);
                    rings.scale.set(mscale, mscale, mscale);
                ...
                loader.load(this.bottom, function (geo) {
                    var bottom = new THREE.Mesh(geo, silver_material);
                    bottom.material.needsUpdate = true;
                    bottom.position.set(0, 0, 0);
                    bottom.scale.set(mscale, mscale, mscale);
                    bottom.castShadow = true;
    ...
    [
        _41 = {
            ...
            light_source:       'lib/models/1171431/light_source.json',
            main_frame:         'lib/models/1171431/main_frame.json',
            silver_clips:       'lib/models/1171431/silver_clips.json',
            light_bulb:         'lib/models/1171431/light_bulb.json',
            rope:               'lib/models/1171431/rope.json',
            scala:              0.6,
            posiy:             -10,
            modposi: function(){
                group.scale.set( this.scala, this.scala, this.scala );
    ...
    [
        _42 = {
            name: 'Lampa wisząca Maxima 30128A0731 Spot Light',
            link: 'https://www.lightcenter.pl/katalog,24109/lampa-wiszaca-maxima-30128a0731-spot-light',
            
            light_source:       'lib/models/30128A0731/light_source.json',
            top:                'lib/models/30128A0731/top.json',
            top_inside:         'lib/models/30128A0731/top_inside.json',
            silver_clips:       'lib/models/30128A0731/silver_clips.json',
            light_bulb:         'lib/models/30128A0731/light_bulb.json',
            rope:               'lib/models/30128A0731/rope.json',
            scala:              0.6,
            posiy:             -10,
            modposi: function(){
                group.scale.set( this.scala, this.scala, this.scala );
            ...
            loadmodel: function () {
                ...
                loader.load(this.top_inside, function (geo) {
                    var top_inside = new THREE.Mesh(geo, matPad);
                    top_inside.material.needsUpdate = true;
                    top_inside.position.set(0, 0, 0);
                    top_inside.scale.set(mscale, mscale, mscale);
                    top_inside.castShadow = true;
    ...
    [
        _43 = {
            name: 'Lampa wisząca Maxima 30428A0728 Spot Light',
            link: 'https://www.lightcenter.pl/katalog,24112/lampa-wiszaca-maxima-30428a0728-spot-light',
    ...
    [
        _44 = {
            name: 'Lampa wisząca Maxima 30428A0729 Spot Light',
            link: 'https://www.lightcenter.pl/katalog,24114/lampa-wiszaca-maxima-30428a0729-spot-light',
