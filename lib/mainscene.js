...
function init(){
    ...
    var txmap = new THREE.TextureLoader().load( 'lib/models/Linus/topjpg.jpg');
    var bmmap = new THREE.TextureLoader().load( 'lib/models/Linus/pobrane.png');
